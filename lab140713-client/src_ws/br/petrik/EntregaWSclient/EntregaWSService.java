 ...
 * 
 */
@WebServiceClient(name = "EntregaWSService", targetNamespace = "http://webservices.petrik.br/", wsdlLocation = "http://localhost:8080/lab140713/EntregaWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ENTREGAWSSERVICE_QNAME = new QName("http://webservices.petrik.br/", "EntregaWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab140713/EntregaWS?wsdl");
    ...
    public EntregaWS getEntregaWSPort() {
        return super.getPort(new QName("http://webservices.petrik.br/", "EntregaWSPort"), EntregaWS.class);
    }
    ...
    public EntregaWS getEntregaWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.petrik.br/", "EntregaWSPort"), EntregaWS.class, features);
    }
