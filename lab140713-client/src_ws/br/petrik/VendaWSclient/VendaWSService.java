 ...
 * 
 */
@WebServiceClient(name = "VendaWSService", targetNamespace = "http://webservices.petrik.br/", wsdlLocation = "http://localhost:8080/lab140713/VendaWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName VENDAWSSERVICE_QNAME = new QName("http://webservices.petrik.br/", "VendaWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab140713/VendaWS?wsdl");
    ...
    public VendaWS getVendaWSPort() {
        return super.getPort(new QName("http://webservices.petrik.br/", "VendaWSPort"), VendaWS.class);
    }
    ...
    public VendaWS getVendaWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.petrik.br/", "VendaWSPort"), VendaWS.class, features);
    }
